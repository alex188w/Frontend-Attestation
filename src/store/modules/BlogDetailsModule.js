export default {
    state: {
        listOfProject: [
            ...
            },
            {
              id: "bedroom",
              firstheading:
                "A bedroom or bedchamber is a room situated within a residential",
              src: require("@/assets/img/bedroom.png"),
              date: "26 December, 2022",
              firstparagraph:
            ...
            },
            {
              id: "building",
              firstheading:
                "A building is 'a structure that has a roof and walls and stands more",
            ...
            },
            {
              ...
              src: require("@/assets/img/kitchen_planning.png"),
              date: "26 December, 2022",
              firstparagraph:
                "Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injecthumour, or randomised words which don't look even slightly believable.",
              secondparagraph:
    ...
    getters: {
        getListOfProject(state) {
            return state.listOfProject;
        },
    },
}